...
# Future Work
In the future, we would want to look at some of the other sectors that have been affected by Covid-19. We chose 4 of the sectors we thought we could get interesting correlation readings from, but there are many more we could look at it. It would also be interesting to see how our vaccine stocks that we looked at are affected by the new Omicron variant. This new variant could have huge affects on the stocks and sectors we looked at similar to the delta variant we saw in late 2021. This new look at the variant wouldn't have significant research for a few months. But seeing the difference in strength of Covid variants would be interesting to see in a scatterplot. In five to ten years time, we could see the affects of possible 3-4 new variants and how that affects the global stock market.
